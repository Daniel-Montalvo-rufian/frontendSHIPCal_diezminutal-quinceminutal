# Generated by Django 3.0.3 on 2020-09-21 14:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_solartime', models.CharField(choices=[('on', 'Yes'), ('off', 'No')], max_length=3, verbose_name='Calculate solar time')),
                ('huso', models.FloatField(verbose_name='In case you have choosen to calculate the solar time, write the difference between the time format of the TMY and the UTC')),
                ('date', models.DateTimeField(auto_now=True, verbose_name='Date')),
                ('itercontrol', models.CharField(choices=[('paso_10min', 'ten-minutes steps'), ('paso_15min', 'fifteen-minutes steps'), ('horario', 'hourly steps')], max_length=10, verbose_name='Step control')),
                ...
                ('month_ini_sim', models.FloatField(default=1, validators=[django.core.validators.MinValueValidator(0, message='The month cannot be less or equal to 0'), django.core.validators.MaxValueValidator(13, message='The month cannot be greater than 12')], verbose_name='Month in which the simulation starts')),
                ('month_fin_sim', models.FloatField(default=1, validators=[django.core.validators.MinValueValidator(0, message='The month cannot be less or equal to 0'), django.core.validators.MaxValueValidator(13, message='The month cannot be greater than 12')], verbose_name='Month in which the simulation ends')),
                ('day_ini_sim', models.FloatField(default=1, validators=[django.core.validators.MinValueValidator(0, message='The day cannot be less or equal to 0'), django.core.validators.MaxValueValidator(32, message='The day cannot be greater than 31')], verbose_name='Day in which the simulation starts')),
                ('day_fin_sim', models.FloatField(default=1, validators=[django.core.validators.MinValueValidator(0, message='The month cannot be less or equal to 0'), django.core.validators.MaxValueValidator(32, message='This cannot be greater than 31')], verbose_name='Day in which the simulation ends')),
                ('hour_fin_sim', models.TimeField(verbose_name='Ending hour of simulation')),
                ('hour_ini_sim', models.TimeField(verbose_name='Starting hour of simultation. ')),
                ('hourEND', models.FloatField(verbose_name='Last hour with demand in the day')),
                ('hourINI', models.FloatField(verbose_name='First hour with demand in the day')),
